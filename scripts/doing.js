class Doing {
    ...
    render = () => {
        ...
        deleteBtn.addEventListener('click', function () {
            ...
            database.ref('Tasks/Doing/' + deleteBtn.id).remove();
        ...
        nextBtn.addEventListener('click', function () {
            const database = firebase.database();
            database.ref('Tasks/Done/' + taskObj.id).set(taskObj);
            database.ref('Tasks/Doing/' + taskObj.id).remove();
        ...
        previousBtn.addEventListener('click', function () {
            const database = firebase.database();
            database.ref('Tasks/To Do/' + taskObj.id).set(taskObj);
            database.ref('Tasks/Doing/' + taskObj.id).remove();
